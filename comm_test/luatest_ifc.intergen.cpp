...
void main_cls::evt1( int a, int* b, iref<ns::other>& d )
{
	if (!_ifc) 
...
coid::charstr main_cls::evt2( int a, int* b, ns1::dummy& c, iref<ns::other>& d, iref<ns::other> e )
{
	if (!_ifc) 
...
iref<ns::main> main_cls::evt4( int a, iref<ns::other> b, int& c, iref<ns::other>& d, int e )
{
	if (!_ifc) 

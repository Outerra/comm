...
protected:
    ...
    static iref<other> _generic_interface_creator(::ns1::other_cls* host, other* __here__)
    {
        ...
        other_dispatcher* dispatcher = __here__
            ? static_cast<other_dispatcher*>(__here__)
...
protected:
    ...
    static iref<main> _generic_interface_creator(::ns1::main_cls* host, main* __here__)
    {
        ...
        if (rval.is_empty()) {
            ...
            main_dispatcher* dispatcher = __here__
                ? static_cast<main_dispatcher*>(__here__)
                : new main_dispatcher;
            rval.create(dispatcher);
...
public:
    ...
    static void register_interfaces( bool on )
    {
        ...
        interface_register::register_interface_creator(
            "ns::main.create@3187450219",
            on ? (void*)&create : nullptr);
        interface_register::register_interface_creator(
            "ns::main.create_special@3187450219",
            on ? (void*)&create_special : nullptr);
        interface_register::register_interface_creator(
            "ns::main.create_wp@3187450219",

...
iref<::lua::registry_handle> lua_ns_other_create_wrapper(const iref<ns::other>&, iref<::lua::registry_handle>);
iref<::lua::registry_handle> lua_ns_main_create_wrapper(const iref<ns::main>&, iref<::lua::registry_handle>);
...
//stream out
        ...
        lua_ns_other_create_wrapper(b, ifc->_context)->get_ref();
        lua_setfield(L, -2, "b");
...
////////////////////////////////////////////////////////////////////////////////
///Create LUA wrapper from an existing interface object
iref<::lua::registry_handle> lua_ns_other_create_wrapper( const iref<ns::other>& orig, iref<::lua::registry_handle> context )
{
    return ns::lua::create_wrapper_other(orig.get(), context);
}
////////////////////////////////////////////////////////////////////////////////
//
...
//stream out
        ...
        lua_createtable(L,0,_res_count);
        iref<::lua::registry_handle> _rval_lua_handle = lua_ns_other_create_wrapper(_rval_, ifc->_context);
        _rval_lua_handle->get_ref();
...
// stream in args and lua function for event call
    ...
    lua_ns_other_create_wrapper(e, _context)->get_ref();
...
// stream in args and lua function for event call
    ...
    lua_streamer<int>::to_lua(a); // TODO: volatile streamers
    lua_ns_other_create_wrapper(b, _context)->get_ref();
...
////////////////////////////////////////////////////////////////////////////////
///Create LUA wrapper from an existing interface object
iref<::lua::registry_handle> lua_ns_main_create_wrapper( const iref<ns::main>& orig, iref<::lua::registry_handle> context )
{
    return ns::lua::create_wrapper_main(orig.get(), context);
}

...
iglexer::iglexer()
{
    ...
    IGKWD = def_keywords( "ifc_class:ifc_classx:ifc_class_inheritable:ifc_class_inherit:ifc_class_var:ifc_classx_var:ifc_class_var_inheritable:ifc_class_var_inherit:ifc_class_virtual:ifc_struct:ifc_fn:ifc_fnx:ifc_event:ifc_eventx:ifc_in:ifc_out:ifc_inout:ifc_ret");

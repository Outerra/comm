...
protected:
    int _indent = 0;
    int lexid = 0, lexstr = 0, lexchr = 0;
    int lexstre = 0, lexchre = 0;
...
public:
    ...
    {
        init(0, 0, enable_esc_strings);
    }

    fmtstreamjson(binstream& b, bool enable_esc_strings, bool utf8 = true) : fmtstream_lexer(utf8)
    {
        init(&b, &b, enable_esc_strings);
    }

    fmtstreamjson(binstream* br, binstream* bw, bool enable_esc_strings, bool utf8 = true) : fmtstream_lexer(utf8)
    {
        init(br, bw, enable_esc_strings);
    }
